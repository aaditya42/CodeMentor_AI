...
export const LANGUAGES = ['PYTHON', 'CPP', 'JAVA', 'JAVASCRIPT'] as const;
...
export const API_ROUTES = {
  ...
  PROBLEMS: {
    LIST: '/api/problems',
    GET: (slug: string) => `/api/problems/${slug}`,
  ...
  HINTS: {
    ...
    HISTORY: (problemId: string) => `/api/hints/history/${problemId}`,
  },
  CONVERSATIONS: {
    GET: (problemId: string) => `/api/conversations/${problemId}`,
    MESSAGE: (id: string) => `/api/conversations/${id}/message`,
  },
  ANALYTICS: {
